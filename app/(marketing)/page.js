          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="card border border-gray-200">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-flex-navy mb-2">Essential</h3>
                <p className="text-gray-500 text-sm">Perfect for regulars</p>
              </div>
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-flex-navy">£35</span>
                <span className="text-gray-500">/month</span>
              </div>
              <div className="text-center mb-6 text-flex-navy font-semibold">10 drops per month</div>
              <Link href="/join?plan=essential" className="block text-center btn-primary">Get Started</Link>
            </div>

            <div className="card relative border-2 border-flex-accent ring-2 ring-flex-accent ring-opacity-20">
              <div className="popular-badge">Most Popular</div>
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-flex-navy mb-2">Unlimited</h3>
                <p className="text-gray-500 text-sm">For fitness fanatics</p>
              </div>
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-flex-navy">£48</span>
                <span className="text-gray-500">/month</span>
              </div>
              <div className="text-center mb-6 text-flex-navy font-semibold">16 drops per month</div>
              <Link href="/join?plan=unlimited" className="block text-center btn-accent">Get Started</Link>
            </div>

            <div className="card border border-gray-200">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-flex-navy mb-2">Single Drop</h3>
                <p className="text-gray-500 text-sm">Try it out</p>
              </div>
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-flex-navy">£5</span>
                <span className="text-gray-500">/drop</span>
              </div>
              <div className="text-center mb-6 text-flex-navy font-semibold">Pay as you go</div>
