...
# See lib/constants.js for full SID reference with variable signatures
TEMPLATE_WELCOME_SID=HXxxx
TEMPLATE_MAIN_MENU_SID=HXxxx
TEMPLATE_VERIFY_CODE_SID=HXxxx
TEMPLATE_DROP_GUIDE_SID=HXxxx
TEMPLATE_DROP_CONFIRMED_SID=HXxxx
TEMPLATE_READY_PICKUP_SID=HXxxx
TEMPLATE_LOW_DROPS_SID=HXxxx
TEMPLATE_DROPS_RESET_SID=HXxxx
TEMPLATE_PAYMENT_FAILED_SID=HXxxx
TEMPLATE_ADDON_CONFIRMED_SID=HXxxx
TEMPLATE_SUB_CANCELLED_SID=HXxxx
...
TEMPLATE_VERIFY_CODE_SID=
TEMPLATE_DROP_GUIDE_SID=
TEMPLATE_DROP_CONFIRMED_SID=
TEMPLATE_READY_PICKUP_SID=
TEMPLATE_LOW_DROPS_SID=
TEMPLATE_DROPS_RESET_SID=
TEMPLATE_PAYMENT_FAILED_SID=
TEMPLATE_ADDON_CONFIRMED_SID=
TEMPLATE_SUB_CANCELLED_SID=
