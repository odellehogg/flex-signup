...
export const WHATSAPP_COMMANDS = {
  ...
  MENU: ['MENU', 'HI', 'HELLO', 'HEY', 'HOME', '0', 'MAIN_MENU'],
  DROP: ['DROP', '1', 'NEW', 'START_DROP', 'HOW_IT_WORKS'],
  STATUS: ['STATUS', '2', 'TRACK', 'CHECK', 'DROPS', 'TRACK_ORDER', 'CHECK_DROPS'],
  SUPPORT: ['HELP', '3', 'SUPPORT', 'ISSUE', 'PROBLEM', 'REPORT_ISSUE'],
  CANCEL: ['CANCEL', 'BACK'],
  ...
  // Post-pickup feedback buttons
  FEEDBACK_GREAT: ['FEEDBACK_GREAT'],
  FEEDBACK_OK: ['FEEDBACK_OK'],
  FEEDBACK_BAD: ['FEEDBACK_BAD', 'NOT_HAPPY'],
