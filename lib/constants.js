...
//
// ── Plain text only (no template — sendWithFallback skips gracefully) ───────
// sendSupportPrompt, sendPauseConfirmed, sendManageMenu, sendInvalidBagNumber,
// sendPickupConfirmedThanks, sendPickupConfirmRequest, sendPickupReminder
